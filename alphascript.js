...
var promptMessage2 = "Type in '/go(direction)' to move, '/fight' to start a fight, '/mystats' to view your stats, and '/exit' to exit the game.";
...
var myStatsFunc = function () {
    console.log("HP: " + player.HP);
    console.log("Strength: " + player.STR);
    console.log("Magic: " + player.MGC);
    console.log("Level: " + player.LVL);
    console.log("Experience: " + player.XPR);
};
//This displays your stats
...
var FuncFight = function () {
    ...
    while (inBattle) {
        ...
        if (mob1.HP <= 0) {
            ...
            //The level up is here

            player.XPR += mob1.XPR;
            console.log("You gained " + mob1.XPR + " experience points!");
            if (player.XPR >= 9) {
                player.XPR = 0;
                player.LVL += 1;
                console.log("You grew to level " + player.LVL);
                player.HP += 20;
                player.STR += 1;
                player.MGC += 1;
                player.DVP += 1;
